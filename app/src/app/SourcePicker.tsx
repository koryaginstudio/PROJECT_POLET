  ...
  return (
    <section className="panel">
      ...
      <div className="srcblock">
        ...
        <p className="clients__lede">
          Снятый инженер в расчёт не попадёт, его заявки расчёт распределит между остальными. Навык
...
/* Вместо вводных дня — при живой программе расчёта.

   Программа расчёта считает выгрузку заказчика на своей бригаде и вводных
   смены не принимает: снятый инженер, снятый навык и дописанная заявка
   ушли бы в запрос и пропали там молча, а диспетчер думал бы, что расчёт
   их учёл. Свой набор файлом она тоже не считает — участков у неё три, по
...
export function EngineSourceNote({
  ...
  return (
    <section className="panel">
      <div className="dash__section-head">
        <h2 className="dash__section-title">Заявки и бригада</h2>
      </div>
      <div className="srcengine">
        <Icon name="info" size={16} />
        <div className="srcengine__text">
          <p>
            Заявки и бригада берутся из выгрузки заказчика, которую считает программа расчёта.
            {orders !== undefined && engineers !== undefined
              ? ` На выбранном участке ${plural(orders, 'заявка', 'заявки', 'заявок')} и ` +

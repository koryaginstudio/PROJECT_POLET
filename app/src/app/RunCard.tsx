  ...
  return (
    ...
    >
      ...
      <span className="runcard__stamp" title={stampOf(row.run.created)}>
        ...
        {/* Считано не сегодняшним движком. Рядом со временем, тем же
            тихим тоном: это метка записи, как и время, а не её итог.
            Фраза — движка: у сохранённого пересчёта устарел сам план, у
            обычного расчёта числа на этой самой карточке. */}
        {row.run.drift && (

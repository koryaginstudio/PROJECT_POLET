        ...
        <div className="calc__actions">
          <span className="calc__group">
            ...
            <span
              title={
                engineLive
                  ? 'День пошёл не так: авария, инженер выбыл, инженер задержится. Движок пересоберёт остаток смены за полторы секунды'
                  : 'Правка по событию недоступна: её делает движок, а он не запущен. Как включить — в настройках, на вкладке «Данные»'
              }
            >
              <Button
                variant="secondary"

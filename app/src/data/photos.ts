/* Лица инженеров.
   ...
   **Лицо не повторяется.** Двое с одним лицом в соседних карточках читаются
   как сбой данных. Снимков сорок шесть, инженеров тридцать четыре — на всех
   хватает с запасом, знак остаётся только подстраховкой на случай, если штат
   вырастет ещё до того, как найдутся новые снимки. Положите в `public/photos`
   ещё, допишите их сюда, и они разберутся сами: знаки уступят место
   фотографиям.

...
def _one(args) -> dict:
    ...
    plan = fast.solve(day, params=improved.Params(buffer_step=0.0,
                                                  lns_seconds=OUR_SECONDS), seed=seed)
    assert not plan.check_invariants(day), "наш план невалиден"

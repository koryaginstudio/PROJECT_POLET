...
def _one_day(seed: int) -> dict:
    ...
    assert not plan_g.check_invariants(day), f"жадный нарушил инварианты, seed {seed}"
    ...
    assert not plan_i.check_invariants(day), f"улучшенный нарушил инварианты, seed {seed}"
